...
def main(args):
    ...
    pathc='/home/disk1/zhzhang/data/clean_testset_16kwav/'###干净
    pathe='/home/disk1/user2/mxy/HolidayWork/sps_tas/spk1'
    pathn='/home/disk1/zhzhang/data/noisy_testset_16kwav/'###带噪
...
if __name__ =='__main__':
    ...
    parser.add_argument(
        '--wav_list',
        type=str,
        default='/home/disk1/user2/mxy/HolidayWork_gruc/wav.lst'
        ) 
    parser.add_argument(
        '--result_list',
        type=str,
